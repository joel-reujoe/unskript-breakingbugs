...
//A core logical function to log to firebase
    ...
    static search=async(client,index, body)=>{
        return new Promise(async(resolve,reject)=>{
    ...
    static index=async(client,index,type,articles,next)=>{
        return new Promise(async(resolve,reject)=>{
            try{
                let bulkBody = [];   
                ...
                var errorCount=0;
                var response=await client.bulk({body: bulkBody})
    ...
    static writeToFile=async(filePath,data)=>{
