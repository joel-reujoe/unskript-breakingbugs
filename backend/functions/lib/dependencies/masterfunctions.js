...
Master_Functions.search = (client, index, body) => __awaiter(this, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        resolve(client.search({ index: index, body: body }));
    }));
    // return client.search({index: index, body: body});
});
Master_Functions.index = (client, index, type, articles, next) => __awaiter(this, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        try {
            let bulkBody = [];
            articles.forEach(item => {
                bulkBody.push({ index: { _index: index, _type: type, _id: item.doc_id } });
                bulkBody.push(item);
            });
            var errorCount = 0;
            var response = yield client.bulk({ body: bulkBody });
            response.items.forEach(item => {
                if (item.index && item.index.error) {
                    console.log(++errorCount, item.index.error);
                }
            });
            resolve({ status: true, errorCount: errorCount });
        }
        catch (e) {
            next(e);
        }
...
Master_Functions.writeToFile = (filePath, data) => __awaiter(this, void 0, void 0, function* () {
    fs3.writeFileSync(filePath, JSON.stringify(data.data), function (err) {
        if (err) {
